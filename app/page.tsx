...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-bite-primary">
      <div className="text-center space-y-8 p-8 w-full max-w-5xl">
        ...
        <p className="text-2xl text-white mb-12 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link 
            href="/client"
            className="bg-white p-8 rounded-xl shadow-2xl hover:shadow-3xl transition-all transform hover:-translate-y-2 hover:scale-105"
          >
            <div className="text-5xl mb-4">👤</div>
            <h2 className="text-2xl font-bold text-bite-primary mb-3">
              Client
            </h2>
            <p className="text-bite-gray-600">
